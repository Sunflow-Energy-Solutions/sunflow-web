...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-navy-950">
      ...
      <Container className="relative flex min-h-[calc(100vh-5rem)] flex-col justify-center py-24 sm:py-28">
        <Reveal>
        ...
        <Reveal delay={90}>
          <h1 className="max-w-3xl font-display text-balance text-4xl font-bold leading-[1.08] text-white sm:text-5xl lg:text-6xl xl:text-[4.4rem]">
            Power Your World,
        ...
        <Reveal delay={170}>
          <p className="mt-6 max-w-xl text-balance text-lg leading-relaxed text-mist-200 sm:text-xl">
